...
data5 = pd.read_excel('C:/Users/tianxinxin/Desktop/today/data-0907.xlsx')
...
def lagging(data):
    ...
    for i in range(len(data)):
        ...
        if index_2<=len(data):
            values = data.iloc[index_2-1:index_2]
...
data_pre_905.to_csv('C:/Users/tianxinxin/Desktop/today/data/data_0907_1.csv',encoding="utf_8_sig")
'''
data_pre_905 = data_prepare(data_905)
